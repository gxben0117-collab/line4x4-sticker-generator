...
- 正式頁面版本：`v2.7.0`
- 最新快照：`versions/貼圖line4x4咒語產生器-v2.7.0.html`

## 功能摘要

- **3 種內容模式合一，可混搭**：👤💬 人物＋文字／👤✨ 人物＋情緒特效（24 張情緒卡）／🔤 純文字主體，同一組 16 張貼圖可自由混用（規劃見 `docs/project/V4_HANDOFF_三模式合一.md`）
- **主圖／標籤圖 Prompt**：LINE 上架必備的 240×240 主圖與 96×74 標籤圖，一鍵生成對應 Prompt
- 背景預設青綠去背底，方便去背成透明貼圖（也可選白底／AI背景）
